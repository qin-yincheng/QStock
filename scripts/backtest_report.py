...
用法：python scripts/backtest_report.py --symbol 600519.SH
      python scripts/backtest_report.py --symbol 300750.SZ --mode fused --sdt 20250101
"""
import sys
import os
import argparse
...
def main():
    ...
    parser.add_argument("--sdt", default=None,
                        help="开始日期 YYYYMMDD（默认365天前）")
    parser.add_argument("--edt", default=None,
                        help="结束日期 YYYYMMDD（默认今天）")
    parser.add_argument("--mode", default="both", choices=["dragon", "fused", "both"],
